...
public class JFSuplier extends javax.swing.JFrame {
    ...
    public JFSuplier() {
        initComponents();
        this.setTitle("Data Suplier");
        this.setLocationRelativeTo(getRootPane());
        this.setAlwaysOnTop(true);
        this.setResizable(false);
        this.ID.setVisible(false);
        suplier = new c_suplier(this);
        suplier.isiTabel();
    }
    ...
    private void initComponents() {
        ...
        panel_tabel.setBorder(javax.swing.BorderFactory.createTitledBorder("Data Suplier"));
        ...
        panel_form.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, -1, -1));
